...
let HZRecorder = function (stream, config) {
    ...
    this.upload = function (url, callback) {
        ...
        let voiceSize = blobData.size;
        blobToDataBase64(blobData,function(res){    
            ...
            ajax({
                ...
                method: 'post',
                data: {
                    voiceData: encodeURIComponent(voiceData),
                    voiceSize: voiceSize
                },
                success: function(res){
                    console.log(res);
                    res = JSON.parse(res);
                    let voiceData = res.voiceData;
                    let oAudio = document.createElement('audio');
                    oAudio.src = 'data:audio/mp3;base64,'+voiceData;
        ...
        // xhr.send(fd);
        // blob数据转为base64
        function blobToDataBase64(blob,callback){
